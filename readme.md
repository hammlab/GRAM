...
##  Installing GRAM
####Requirements
1.	ITK:  For the package to build properly, you need to have ITK library built with “review” option on (this is standard for SBIA environment). For more information on installing ITK, go to http://www.itk.org/ITK/resources/software.html. The package was test with ITK 3.14.
